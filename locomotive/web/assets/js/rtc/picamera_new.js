...
export class PiCamera {
    ...
    constructor(cameraId, options, mqttOptions, mqttClient) {
        ...
        this.debug('[picamera] %cinitializing...', ConsoleColors.yellow, this.options);
    }
    ...
    createPeer = async () => {
        ...
        pc.onnegotiationneeded = async () => {
            this.debug('[picamera] webrtc event - %connegotiationneeded', ConsoleColors.blue);
    ...
    terminate() {
        console.log('[picamera] terminate');
